...
test.wmahalanobis <- GridFCM.practicum::mahalanobis_index(wimp = wimp, method = "weight", std = FALSE, sign.level = 0.2)
...
wp1p <- graph_ph(test.wphm.se, mark.nva = FALSE, mark.cnt = FALSE)
...
test.bp.wmahalanobis.se <- GridFCM.practicum::mahalanobis_index(wimp = wimp, method = "weight", std = FALSE, sign.level = 0.2)

wp3 <- graph_ph(test.bp.wmahalanobis.se, mark.nva = TRUE, mark.cnt = TRUE)
...
```{r rep_mh_psychlab_se_sp, fig.width = 10, fig.height = 10}

wp3.sp <- graph_ph(test.bp.wmahalanobis.se, mark.nva = TRUE, mark.cnt = TRUE, show.points = FALSE)
...
```{r rep_psychlab_se_mh_plotly, fig.width = 10, fig.height = 10}

wp1mhp <- GridFCM.practicum::graph_ph(test.bp.wmahalanobis.se, mark.nva = FALSE, mark.cnt = TRUE)
...
```{r graph_num_clusters, fig.width = 12, fig.height = 8}
