...
cent.evalues.df <- GridFCM.practicum::eigen_index(wimp = wimp, method = "implications", num.vectors = 2)
...
cent.pcavalues.df <- GridFCM.practicum::pca_index(wimp = wimp, method = "implications", pr.comp = 2)
...
```{r centrality_comparison}

# Ejecución de las fuciones sobre la wimp del caso
mahalanobis.res.lst <- mahalanobis_index(wimp)
eigen.res <- GridFCM.practicum::eigen_index(wimp = wimp, method = "implications", num.vectors = 2)
pca.res <- GridFCM.practicum::pca_index(wimp = wimp, method = "implications", pr.comp = 2)
...
## Combinación con medidas de importancia subjetiva

```{r centrality_results, fig.width = 10, fig.height = 10}
...
## Correlaciones entre las medidas de centralidad

```{r centrality_correlations}

corr.sel <- round(cor(centrality.comb.df[c("p", "h", "importanciaSubjetiva", "totalCentrl", "Rank_Eigen", "Rank_PCA", "Rank_Mahalanobis")],
