...
### Conjunto de constructos global
...
# Centralidad y orden subjetivo de los constructos
...
## Centralidad sobre caso individual de estudio

### Eigenvectores sobre matriz de implicaciones
...
#### Resultado de cálculo de centralidad
...
## Comparativa de métodos de centralidad
...
```{r centrality.comparison_function}
...
### Comparativa aplicada a caso individual de estudio

#### Comparativa para medidas de Test

```{r centrality_ind_comp_test}
...
#### Correlaciones de medidas de centralidad.Test
...
```{r centrality_correlations_test}
...
#### Comparativa para medidas de Retest

```{r centrality_ind_comp_retest}
...
#### Correlaciones de medidas de centralidad. Retest

```{r centrality_correlations_retest}
...
### Comparativa aplicada a todas las observaciones

#### Comparativa para medidas de Test

```{r lapply_centrality.comp}
...
#### Correlaciones entre las medidas generales de centralidad. Test

```{r centrality_gen_correlations}
...
```{r lapply_centrality.comp_retest}
...
#### Correlaciones entre las medidas generales de centralidad. Retest

```{r centrality_gen_correlations_retest}
